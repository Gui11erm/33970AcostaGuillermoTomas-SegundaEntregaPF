/* 
    ...
    UN SIMULADOR VISTO DESDE EL LADO DEL OPERADOR
    QUE INGRESA PRODUCTOS, REPORTA ERRORES DE STOCK,
    REALIZA FACTURACIONES A CLIENTES, ACTUALIZA DATOS
    Y HACE CONSULTAS EN LA BASE DE DATOS
*/
...
class Producto {
    ...
    previoCarrito(){
        if((this.stock - egresoStock) < 0) {
            ...
            return [this.nombreProducto , egresoStock, this.precio*egresoStock]
        }
    }
    ...
    if(divFacturacion.classList == 'divs divFacturacion'){
        ...
        idForm.addEventListener('submit', (e) => {
            ...
            <form id="idForm">
                <div class="mb-3">
                    <label for="nombreCliente" class="form-label">Cliente</label>
                    <input type="text" class="form-control" id="nombreCliente" value="${cliente}" readonly>
                </div>
                <div class="mb-3">
                    <label for="nombreProducto" class="form-label">Producto a facturar</label>
                    <input type="text" class="form-control" id="nombreProducto" required>
